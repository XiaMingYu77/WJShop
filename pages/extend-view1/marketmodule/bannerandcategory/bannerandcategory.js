...
Page({
  ...
  onLoad: function(options) {
    ...
    util.request("/WxHome/GetPromActivityInfo", {
      ...
      this.setData({
        ...
        category: res.data.ProductCategroylist,
        categorynum: res.data.ProductCategroylist.length
      })
      var innerwidth = 60 * (5 / this.data.categorynum)
      this.setData({
        innerwidth
      })
    })
  ...
  tomoreclasic:function(e){
    var cur=e.currentTarget.dataset.key
    var id = e.currentTarget.dataset.id
    wx.navigateTo({
      url: `../moreclasic/moreclasic?key=${cur}&id=${id}`
    })
  },
